...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <form class="form_create" name="create_form" action="{{ url('/admin-post') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ url('/admin-post-update') }}"method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  @endif
                                    ...
                                    @if($datas->status==1)
                                    <a href="{{url('/allpost-status',['id'=>$datas->id])}}" class="btn btn-success" title="Active">
                                        <span class="fa fa-arrow-up"></span>
                                    </a>
                                    @elseif($datas->status==0)
                                    <a href="{{url('/allpost-status',['id'=>$datas->id])}}" class="btn btn-danger" title="Inactive">
                                            <span class="fa fa-arrow-down"></span>
                                        </a>
                                    @endif
                                    <a href="{{url('/allpost/delete/'.$datas->id)}}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?')">
